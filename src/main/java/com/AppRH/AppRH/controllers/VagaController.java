...
public class VagaController {
	...
	public String form(@jakarta.validation.Valid Vaga vaga, BindingResult result, RedirectAttributes attributes) {
	...
	public String detalhesVagaPost(@PathVariable("codigo") long codigo, @Validated Candidato candidato,
	...
	public String updateVaga(@jakarta.validation.Valid Vaga vaga, BindingResult result, RedirectAttributes attributes) {
		vr.save(vaga);
